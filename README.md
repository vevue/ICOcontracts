...
使用者可以通过Vevue在任何位置发起视频拍摄悬赏，可以是国内的某个景点，可以是国外某个向往已久的海滩，也可以是极地极光、海上日出日落或者是一段街头艺术，用你喜欢的方式去定义拍摄类型，或者航拍，或者延时摄影，只要你喜欢。
你的这些请求会被Vevue统统打包好发送到Vevue地图上并推送给符合条件的拍摄爱好者，完成任务即可领取奖赏。一切都是那么简单，视觉旅游如果只有眼睛参与那太遗憾了，全身心的参与才叫体验。
